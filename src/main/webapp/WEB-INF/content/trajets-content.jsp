                    ...
                    <form action="<%= request.getContextPath() %>/vehicules" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="capaciteCarburant" name="capaciteCarburant"
                                   value="<%= vehicule != null ? vehicule.getCapaciteCarburant() : "" %>" required>
                        </div>
                        <div class="mb-3">
                            <label for="depenseCarburant100km" class="form-label">Dépense Carburant / 100km</label>
                            <input type="number" step="0.01" class="form-control" id="depenseCarburant100km" name="depenseCarburant100km"
                                   value="<%= vehicule != null ? vehicule.getDepenseCarburant100km() : "" %>" required>
                        </div>
                        <div class="mb-3">
