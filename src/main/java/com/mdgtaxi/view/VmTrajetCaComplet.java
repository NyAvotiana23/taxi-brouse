...
@Subselect("""
    SELECT
        ...
        COALESCE(prev.ca_previsionnel, 0) AS ca_previsionnel,
        ...
        COALESCE(reel.ca_reel, 0) AS ca_reel,
        COALESCE(prev.ca_previsionnel, 0) - COALESCE(reel.ca_reel, 0) AS ecart_ca
    FROM Trajet t
